    ...
    <el-dialog title="角色详情" v-model="viewDialogVisible" width="600px">
      <div v-if="viewData" class="detail-content">
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="角色编码">{{ viewData.code }}</el-descriptions-item>
          ...
          <el-descriptions-item label="权限" span="2">
            <el-tag v-for="permission in viewData.permissions" :key="permission.id" style="margin-right: 8px; margin-bottom: 8px;">
              {{ permission.name }}
            </el-tag>
            <span v-if="!viewData.permissions.length" style="color: #999;">暂无权限</span>
          </el-descriptions-item>
        </el-descriptions>
      </div>
    </el-dialog>
